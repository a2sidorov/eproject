...
INSERT INTO countries (name) VALUES ('Croatia (Hrvatska)');
...
INSERT INTO countries (name) VALUES ('South Georgia South Sandwich Islands');
...
INSERT INTO countries (name) VALUES ('St. Helena');
INSERT INTO countries (name) VALUES ('St. Pierre and Miquelon');
...
INSERT INTO roles (role_id, name) VALUES (3, 'ROLE_CLIENT');

-- CREATING USERS
-- admin
INSERT INTO users (user_id, first_name, last_name, date_of_birth, email, password)
  VALUES (1, 'Admin', 'Lastname', '2000-01-01', 'admin@mail.dev',
  '$2a$10$HjaSqK6GJxQi9OoxTKlTu.QrxJb6roOUL3FBFgMi7ENSylC29Gr7q');

INSERT INTO users_roles (user_id, role_id) VALUES (1, 1);

INSERT INTO addresses (country_id, city, street, postalCode, house, apartment, user_id)
  VALUES ((SELECT country_id FROM countries WHERE name = 'United States'),
          'City', 'Street', 'Postal code', '1', '1', 1);

-- manager
INSERT INTO users (user_id, first_name, last_name, date_of_birth, email, password)
  VALUES (2, 'Manager', 'Lastname', '2000-01-01', 'manager@mail.dev',
          '$2a$10$HjaSqK6GJxQi9OoxTKlTu.QrxJb6roOUL3FBFgMi7ENSylC29Gr7q');

INSERT INTO users_roles (user_id, role_id) VALUES (2, 2);

INSERT INTO addresses (country_id, city, street, postalCode, house, apartment, user_id)
  VALUES (1,'City', 'Street', 'Postal code', '1', '1', 2);

-- client
INSERT INTO users (user_id, first_name, last_name, date_of_birth, email, password)
  VALUES (3, 'Client', 'Lastname', '2000-01-01', 'client@mail.dev',
          '$2a$10$HjaSqK6GJxQi9OoxTKlTu.QrxJb6roOUL3FBFgMi7ENSylC29Gr7q');

INSERT INTO users_roles (user_id, role_id) VALUES (3, 3);

INSERT INTO addresses (country_id, city, street, postalCode, house, apartment, user_id)
  VALUES (1, 'City', 'Street', 'Postal code', '1', '1', 3);

-- CREATING PRODUCT CATEGORIES
INSERT INTO categories (category_id, name, type, parentCategory_category_id)
  VALUES (1, 'Circuit breakers', 'folder', null);

INSERT INTO categories (category_id, name, type, parentCategory_category_id)
  VALUES (2, 'Miniature circuit breakers', 'category', 1);

INSERT INTO categories (category_id, name, type, parentCategory_category_id)
  VALUES (3, 'Molded-case circuit breaker', 'category', 1);

INSERT INTO categories (category_id, name, type, parentCategory_category_id)
  VALUES (4, 'Air Circuit Breaker', 'category', 1);

INSERT INTO categories (category_id, name, type, parentCategory_category_id)
  VALUES (5, 'Enclosures', 'folder', null);

INSERT INTO categories (category_id, name, type, parentCategory_category_id)
  VALUES (6, 'Modular enclosures', 'category', 5);

INSERT INTO categories (category_id, name, type, parentCategory_category_id)
  VALUES (7, 'Wall-mounting enclosures', 'category', 5);

INSERT INTO categories (category_id, name, type, parentCategory_category_id)
  VALUES (8, 'Wall-standing enclosures', 'category', 5);

-- CREATING MEASURE UNITS
INSERT INTO measure_units (name) VALUES ('pieces');

-- CREATING PRODUCTS
-- IC60N 1P 6A
INSERT INTO products (product_id, name, selling_price, image_url, height, width, depth, weight, quantity_in_stock,
                      quantity_reserved, sale_count, category_id, measure_units_id)
  VALUES (1, 'IC60N - miniature circuit breaker - 1P - 6A - C curve', 20.00,
          '/resources/img/small_a9f79106.jpg',
          0.085, 0.085, 0.0785, 0.018, 15, 0, 0, 2, 1);

INSERT INTO prices (creation_date, price, product_id)
  VALUES ('2019-04-04', 5.00, 1);

-- IC60N 1P 10A
INSERT INTO products (product_id, name, selling_price, image_url, height, width, depth, weight, quantity_in_stock,
                      quantity_reserved, sale_count, category_id, measure_units_id)
  VALUES (2, 'IC60N - miniature circuit breaker - 1P - 10A - C curve', 20.00,
            '/resources/img/small_a9f79106.jpg',
            0.085, 0.085, 0.0785, 0.018, 14, 0, 0, 2, 1);

INSERT INTO prices (creation_date, price, product_id)
  VALUES ('2019-04-04', 5.00, 2);

-- IC60N 1P 16A
INSERT INTO products (product_id, name, selling_price, image_url, height, width, depth, weight, quantity_in_stock,
                      quantity_reserved, sale_count, category_id, measure_units_id)
  VALUES (3, 'IC60N - miniature circuit breaker - 1P - 16A - C curve', 20.00,
          '/resources/img/small_a9f79106.jpg',
          0.085, 0.085, 0.0785, 0.018, 13, 0, 0, 2, 1);

INSERT INTO prices (creation_date, price, product_id)
  VALUES ('2019-04-04', 5.00, 3);

-- NSX100 1P 100A
INSERT INTO products (product_id, name, selling_price, image_url, height, width, depth, weight, quantity_in_stock,
                      quantity_reserved, sale_count, category_id, measure_units_id)
  VALUES (4, 'Compact NSX100B - TMD - 100A', 20.00,
          '/resources/img/ODAPB103191_288x288.PNG',
          0.161, 0.105, 0.086, 0.5, 5, 0, 0, 3, 1);

INSERT INTO prices (creation_date, price, product_id)
  VALUES ('2019-04-04', 200.00, 4);

-- NSX250B 3P 160A
INSERT INTO products (product_id, name, selling_price, image_url, height, width, depth, weight, quantity_in_stock,
                      quantity_reserved, sale_count, category_id, measure_units_id)
VALUES (401, 'Compact NSX250B - TMD - 160A', 20.00,
        '/resources/img/ODAPB103191_288x288.PNG',
        0.161, 0.105, 0.086, 0.5, 5, 0, 0, 3, 1);
INSERT INTO prices (creation_date, price, product_id)
VALUES ('2019-04-04', 200.00, 401);

-- NSX250B 3P 200A
INSERT INTO products (product_id, name, selling_price, image_url, height, width, depth, weight, quantity_in_stock,
                      quantity_reserved, sale_count, category_id, measure_units_id)
VALUES (402, 'Compact NSX250B - TMD - 200A', 20.00,
        '/resources/img/ODAPB103191_288x288.PNG',
        0.161, 0.105, 0.086, 0.5, 5, 0, 0, 3, 1);
INSERT INTO prices (creation_date, price, product_id)
VALUES ('2019-04-04', 200.00, 402);

-- NSX250B 3P 250A
INSERT INTO products (product_id, name, selling_price, image_url, height, width, depth, weight, quantity_in_stock,
                      quantity_reserved, sale_count, category_id, measure_units_id)
VALUES (403, 'Compact NSX250B - TMD - 250A', 20.00,
        '/resources/img/ODAPB103191_288x288.PNG',
        0.161, 0.105, 0.086, 0.5, 5, 0, 0, 3, 1);
INSERT INTO prices (creation_date, price, product_id)
VALUES ('2019-04-04', 200.00, 403);

-- Hensel KV
INSERT INTO products (product_id, name, selling_price, image_url, height, width, depth, weight, quantity_in_stock,
                      quantity_reserved, sale_count, category_id, measure_units_id)
  VALUES (5, 'Hensel KV 9336 Enclosure IP 65', 20.00,
          '/resources/img/hensel-box.jpeg',
          0.6, 0.3, 0.1, 4.5, 1, 0, 0, 6, 1);
INSERT INTO prices (creation_date, price, product_id)
  VALUES ('2019-04-04', 75.00, 5);

-- Spacial CRN
INSERT INTO products (product_id, name, selling_price, image_url, height, width, depth, weight, quantity_in_stock,
                      quantity_reserved, sale_count, category_id, measure_units_id)
  VALUES (6, 'Spacial CRN', 20.00,
          '/resources/img/wall-mounted.jpeg',
          0.8, 0.6, 0.2, 20.5, 1, 0, 0, 7, 1);
INSERT INTO prices (creation_date, price, product_id)
  VALUES ('2019-04-04', 400.00, 6);

-- Spacial SFX
INSERT INTO products (product_id, name, selling_price, image_url, height, width, depth, weight, quantity_in_stock,
                      quantity_reserved, sale_count, category_id, measure_units_id)
  VALUES (7, 'Spacial SFX', 20.00,
          '/resources/img/2545_main_web.JPG',
          2.0, 1.0, 0.5, 40.5, 1, 0, 0, 8, 1);
INSERT INTO prices (creation_date, price, product_id)
  VALUES ('2019-04-04', 400.00, 7);

-- EasyPact MVC 4000
INSERT INTO products (product_id, name, selling_price, image_url, height, width, depth, weight, quantity_in_stock,
                      quantity_reserved, sale_count, category_id, measure_units_id)
  VALUES (8, 'EasyPact MVS 4000A', 20.00,
          '/resources/img/MVS400_4000A_web.JPG',
          0.5, 0.5, 0.5, 50.5, 1, 0, 0, 4, 1);
INSERT INTO prices (creation_date, price, product_id)
  VALUES ('2019-04-04', 3000.00, 8);

-- EasyPact MVC 2500
INSERT INTO products (product_id, name, selling_price, image_url, height, width, depth, weight, quantity_in_stock,
                      quantity_reserved, sale_count, category_id, measure_units_id)
VALUES (9, 'EasyPact MVS 2500A', 20.00,
        '/resources/img/MVS400_4000A_web.JPG',
        0.5, 0.5, 0.5, 50.5, 1, 0, 0, 4, 1);
INSERT INTO prices (creation_date, price, product_id)
VALUES ('2019-04-04', 1600.00, 9);


/*
-- CREATING ORDERS
INSERT INTO orders (order_id, creation_date_time, order_status, payment_method,
                    payment_status, shipping_method, total_purchasing_price,
                    total_selling_price, address_id, user_id)
VALUES (1, '2018-01-01 12:11:00', 1, 0, 0, 0, 1000.00,
        100.00, 2, 2);
INSERT INTO orders_products (selling_price, quantity, product_id, order_id)
VALUES (140.00, 10, 3, 1);

INSERT INTO orders (order_id, creation_date_time, order_status, payment_method,
                    payment_status, shipping_method, total_purchasing_price,
                    total_selling_price, address_id, user_id)
VALUES (2, '2018-02-04 12:11:00', 1, 0, 0, 0, 5.00,
        200.00, 2, 2);
INSERT INTO orders_products (selling_price, quantity, product_id, order_id)
VALUES (7.00, 1, 1, 2);
...
INSERT INTO orders (order_id, creation_date_time, order_status, payment_method,
                    payment_status, shipping_method, total_purchasing_price,
                    total_selling_price, address_id, user_id)
VALUES (3, '2018-03-04 12:11:00', 1, 0, 0, 0, 5.00,
        300.00, 2, 2);
INSERT INTO orders_products (selling_price, quantity, product_id, order_id)
VALUES (7.00, 1, 1, 3);
...
INSERT INTO orders (order_id, creation_date_time, order_status, payment_method,
                    payment_status, shipping_method, total_purchasing_price,
                    total_selling_price, address_id, user_id)
VALUES (4, '2018-04-04 12:11:00', 1, 0, 0, 0, 5.00,
        400.00, 2, 3);
INSERT INTO orders_products (selling_price, quantity, product_id, order_id)
VALUES (7.00, 1, 1, 4);
...
INSERT INTO orders (order_id, creation_date_time, order_status, payment_method,
                    payment_status, shipping_method, total_purchasing_price,
                    total_selling_price, address_id, user_id)
VALUES (5, '2018-04-04 12:11:00', 1, 0, 0, 0, 5.00,
        500.00, 2, 3);
INSERT INTO orders_products (selling_price, quantity, product_id, order_id)
VALUES (7.00, 1, 1, 5);
...
INSERT INTO orders (order_id, creation_date_time, order_status, payment_method,
                    payment_status, shipping_method, total_purchasing_price,
                    total_selling_price, address_id, user_id)
VALUES (6, '2018-08-04 12:11:00', 1, 0, 0, 0, 5.00,
        600.00, 2, 3);
INSERT INTO orders_products (selling_price, quantity, product_id, order_id)
VALUES (7.00, 1, 1, 6);
...
INSERT INTO orders (order_id, creation_date_time, order_status, payment_method,
                    payment_status, shipping_method, total_purchasing_price,
                    total_selling_price, address_id, user_id)
VALUES (7, '2019-01-20 12:11:00', 1, 0, 0, 0, 5.00,
        700.00, 2, 3);
INSERT INTO orders_products (selling_price, quantity, product_id, order_id)
VALUES (7.00, 1, 1, 7);
...
INSERT INTO orders (order_id, creation_date_time, order_status, payment_method,
                    payment_status, shipping_method, total_purchasing_price,
                    total_selling_price, address_id, user_id)
VALUES (8, '2019-04-20 12:11:00', 3, 0, 0, 0, 5.00,
        800.00, 2, 3);
INSERT INTO orders_products (selling_price, quantity, product_id, order_id)
VALUES (7.00, 1, 1, 8);
...
INSERT INTO orders (order_id, creation_date_time, order_status, payment_method,
                    payment_status, shipping_method, total_purchasing_price,
                    total_selling_price, address_id, user_id)
VALUES (9, '2019-04-25 12:11:00', 3, 0, 0, 0, 5.00,
        900.00, 2, 3);
INSERT INTO orders_products (selling_price, quantity, product_id, order_id)
VALUES (7.00, 1, 1, 9);
...
INSERT INTO orders (order_id, creation_date_time, order_status, payment_method,
                    payment_status, shipping_method, total_purchasing_price,
                    total_selling_price, address_id, user_id)
VALUES (10, '2019-05-01 12:11:00', 2, 0, 0, 0, 5.00,
        1000.00, 2, 3);
INSERT INTO orders_products (selling_price, quantity, product_id, order_id)
VALUES (7.00, 1, 1, 10);
...
INSERT INTO orders (order_id, creation_date_time, order_status, payment_method,
                    payment_status, shipping_method, total_purchasing_price,
                    total_selling_price, address_id, user_id)
VALUES (11, '2019-05-04 12:11:00', 1, 0, 0, 0, 5.00,
        1100.00, 2, 3);
INSERT INTO orders_products (selling_price, quantity, product_id, order_id)
VALUES (7.00, 1, 1, 11);
*/
